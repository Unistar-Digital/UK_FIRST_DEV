theme: /
    ...
    state: StockBondsFunds
        ...
        inlineButtons:
            "Фонд Инструменты в юанях — SBBY (ранее — Фонд Облигации в юанях)" -> /StockBondsFunds/SBBYFund
            "Фонд Долгосрочные гособлигации — SBLB" -> /StockBondsFunds/SBLBFund
            "Фонд Корпоративные облигации — SBRB" -> /StockBondsFunds/SBRBFund
            "Фонд Государственные облигации — SBGB" -> /StockBondsFunds/SBGBFund
            "Фонд Валютных Облигаций — SBCB (ранее — Фонд Российские еврооблигации)" -> /OpenBondsFunds/SBCBFund
            "Фонд Облигации с переменным купоном — SBFR" -> /StockBondsFunds/SBFRFund
            "Назад" -> /ExchangeTradedFunds
        timeout: /Start/Timeout || interval = "1 hour"
        ...
        state: SBCBFund
            ...
            inlineButtons: 
                ...
                {"text": "Презентация —онд Валютных Облигаций — SBCB (ранее - Фонд Российские еврооблигации)", "url": "https://first-am.ru/?ysclid=m35k4y6ov0984914987"}
    ...
    state: OpenMoneyFunds
        ...
        state: SBCNFund
            a: По поводу фонда cберегательный в юанях могу предоставить следующие документы 📃
            inlineButtons:
