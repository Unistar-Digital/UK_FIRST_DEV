...
init: 
    bind("onScriptError", function($context) {
        ...
        $reactions.answer("К сожалению, сейчас я не смогу проконсультировать Вас, но Вы можете обратиться к нашему сотруднику: - номера телефонов: 8 800 301 1616 (бесплатный звонок по России) и 8 495 258 0534 (для жителей Москвы): - электронная почта info@first-am.ru он поможет Вам с решением данного вопроса")
        $jsapi.stopSession()
    });
